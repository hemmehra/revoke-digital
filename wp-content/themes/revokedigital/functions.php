...
if (!is_admin()) add_action("wp_enqueue_scripts", "my_jquery_enqueue", 11);
	...
	wp_register_script('jquery', "https://ajax.googleapis.com/ajax/libs/jquery/3.6.1/jquery.min.js", false, null);
 ...
 *
 * @since Revoke Digital 1.0
 * @deprecated Revoke Digital 1.9 Removed from wp_print_footer_scripts action.
 *
