	...
	<div id="page" class="site">
		...
		<header>
			<div class="MainHeadSec shadow-[none]">
				<div class="navbar-sticky bg-transparent current:navbar-glass navbar py-[15px] px-0 transition-all ease-in shadow-[none] MainHeadSecInner" id="MainHeadSecInner">
					<div class="container">
										...
										<div class="mr-1">
											<ul class="nav-menu">
												<li class="group/menu inline-block relative">
													<a href="/" class="group-hover/menu:text-primary block font-medium py-2 px-3 transition-all duration-300 ease-in text-white current:text-black">
														Music Distribution
													</a>
												</li>
												<li class="group/menu inline-block relative menu-item-has-children">
													<a href="<?= get_permalink(28); ?>" class="group-hover/menu:text-primary block font-medium py-2 px-3 transition-all duration-300 ease-in text-white current:text-black">
														Services
													</a>

													<!-- menu - start -->
													<div class="absolute top-[calc(100%+15px)] -right-[270%] mx-auto w-[734px] bg-white overflow-hidden rounded-lg border border-gray-4 shadow-sm translate-y-2 opacity-0 invisible group-hover/menu:translate-y-0  group-hover/menu:opacity-100 group-hover/menu:visible transition-all ease-in">
														<div class="m-6 mb-10 grid grid-cols-2 gap-8">
															<!-- link - start -->
															<a href="<?= get_permalink(515); ?>" class="group flex gap-4">
															...
															<!-- link - start -->
															<a href="<?= get_permalink(463); ?>" class="group flex gap-4">
																<div class="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-primary text-white shadow-lg transition duration-100 group-hover:bg-indigo-600 group-active:bg-indigo-700 md:h-12 md:w-12">
																	<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
															...
															<!-- link - start -->
															<a href="<?= get_permalink(517); ?>" class="group flex gap-4">
																<div class="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-primary text-white shadow-lg transition duration-100 group-hover:bg-indigo-600 group-active:bg-indigo-700 md:h-12 md:w-12">
																	<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
															...
															<!-- link - start -->
															<a href="<?= get_permalink(519); ?>" class="group flex gap-4">
																<div class="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-primary text-white shadow-lg transition duration-100 group-hover:bg-indigo-600 group-active:bg-indigo-700 md:h-12 md:w-12">
														...
														<!-- link - start -->
														<a href="javascript:;" class="block bg-gray-5 p-4 px-8 transition duration-100 hover:bg-gray-100 active:bg-gray-2">
															<div class="mb-1 flex items-center gap-1.5">
																<span class="font-semibold leading-none">Artists and labels
																	solutions</span>
																<span class="mt-0.5 rounded-full bg-gray-2 px-2 py-1 text-xs font-semibold leading-none text-white">New</span>
															</div>

															<p class="text-sm">Doing our best for labels and artists.</p>
														</a>
														<!-- link - end -->
													</div>
													<!-- menu - end -->
												...
												<li class="group/menu inline-block relative">
													<a href="<?= get_permalink(24); ?>" class="group-hover/menu:text-primary block font-medium py-2 px-3 transition-all duration-300 ease-in text-white current:text-black">
														About Us
													</a>
												</li>
												<li class="group/menu inline-block relative ">
			...
			<div class="drawer">
				<div class="drawer-content pt-10 flex flex-col h-full px-1 bg-[#f8f8f8] ">
										...
										<div class="menu-items">
											...
											<div>
												...
												<div class="menu-item-collapse">
													<div class="min-h-0">
														<a href="<?= get_permalink(515); ?>#music-distribution" class="menu-item ml-2">Music Distribution</a>
														<a href="<?= get_permalink(463); ?>#marketing" class="menu-item ml-2">Marketing & Promotions</a>
														<a href="<?= get_permalink(519); ?>#youtube-content-id" class="menu-item ml-2">Youtube Content Id</a>
														<a href="<?= get_permalink(517); ?>#royalties-licenses" class="menu-item ml-2">Royalties & Licenses</a>
													</div>
												</div>
											</div>
