<?php
/**
 * Revoke Digital Starter Content
 *
		...
		'posts'     => array(
			'front' => array(
				...
				'post_content' => '
					...
					<!-- wp:paragraph -->
					<p>' . esc_html_x( 'Revoke Digital includes stylish borders for your content. With an Image block selected, open the "Styles" panel within the Editor sidebar. Select the "Frame" block style to activate it.', 'Theme starter content', 'twentytwentyone' ) . '</p>
					<!-- /wp:paragraph --></div>
					<!-- /wp:column -->
					...
					<!-- wp:paragraph -->
					<p>' . esc_html_x( 'Revoke Digital also includes an overlap style for column blocks. With a Columns block selected, open the "Styles" panel within the Editor sidebar. Choose the "Overlap" block style to try it out.', 'Theme starter content', 'twentytwentyone' ) . '</p>
					<!-- /wp:paragraph --></div>
					<!-- /wp:column --></div>
					<!-- /wp:columns -->
