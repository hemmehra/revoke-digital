...
class Twenty_Twenty_One_Dark_Mode {
	...
	public function customizer_controls( $wp_customize ) {
		...
		$description  = '<p>';
		$description .= sprintf(
			/* translators: %s: Revoke Digital support article URL. */
	...
	public function add_privacy_policy_content() {
		...
		$content = '<p class="privacy-policy-tutorial">' . __( 'Revoke Digital uses LocalStorage when Dark Mode support is enabled.', 'twentytwentyone' ) . '</p>'
		...
		wp_add_privacy_policy_content( __( 'Revoke Digital', 'twentytwentyone' ), wp_kses_post( wpautop( $content, false ) ) );
	}
}
